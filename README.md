...
The bump type follows the conventional-commit footer / type, with `bump-patch-for-minor-pre-major: true` enforced while the project is below `1.0.0`:

| Commit prefix              | Pre-1.0.0 bump | Post-1.0.0 bump |
| -------------------------- | -------------- | --------------- |
| `fix:`                     | patch          | patch           |
| `feat:`                    | patch          | minor           |
| `feat!:` or `BREAKING CHANGE:` | patch      | major           |
